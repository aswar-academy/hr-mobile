...
import '../data/local/registration.dart' as _i7;
import '../src/home/home_cubit.dart' as _i8;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  await gh.factoryAsync<_i6.SharedPreferences>(
      ...
      preResolve: true);
  gh.singleton<_i7.RegistrationPreference>(
      _i7.RegistrationPreference(get<_i6.SharedPreferences>()));
  gh.factory<_i8.HomeCubit>(
      () => _i8.HomeCubit(get<_i7.RegistrationPreference>()));
  return get;
}
