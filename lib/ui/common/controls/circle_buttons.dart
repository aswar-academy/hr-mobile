...
import 'package:aswar/ui/common/controls/buttons.dart';
...
class BackBtn extends StatelessWidget {
  ...
  const BackBtn.close(
      ...
      : this(
            ...
            icon: Icons.close,
            onPressed: onPressed,
            semanticLabel: "circleButtonsSemanticClose",
            bgColor: bgColor,
            iconColor: iconColor);
  @override
  Widget build(BuildContext context) {
    return CircleIconBtn(
      ...
      semanticLabel: semanticLabel ?? "circleButtonsSemanticBack",
    );
  }
